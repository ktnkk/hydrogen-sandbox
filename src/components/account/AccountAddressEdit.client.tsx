...
type CallUpdateAddressApiProps = {
  id: string;
  firstName: string;
  lastName: string;
  company: string;
...
export const callUpdateAddressApi = async ({
  id,
  firstName,
  lastName,
  company,
...
export const AccountAddressEdit: FC<AccountAddressEditProps> = ({
  address,
  defaultAddress,
  close,
}) => {
        ...
        <form noValidate onSubmit={onSubmit}>
          ...
          <div className='mt-4'>
            <input
              ...
              className='rounded-sm border-gray-500 cursor-pointer border-1'
